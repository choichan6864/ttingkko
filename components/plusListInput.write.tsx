...
export default function ListInput({
  ...
  const [plusInput, setPlusInput] = useState(Contents === "");
  ...
  const onClickCancelButton = () => {
    if (Contents === "" && ListText === "") remove(index);
      ...
      setInput({ listText: ListText, contents: Contents });
      setPlusInput(false);
    }
  };
    ...
    <>
      {plusInput ? (
        ...
        <div className="list" key={index}>
          ...
          ></div>
          <input type="hidden" name="listText" value={input.listText}></input>
          <input type="hidden" name="contents" value={input.contents}></input>
        </div>
      )}
      <style jsx>
        {`
