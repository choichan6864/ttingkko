    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(typeof page === "number" && page > 0)) return [3 /*break*/, 3];
                return [4 /*yield*/, connection_1.default.query("SELECT COUNT(*) as cnt FROM contents")];
            case 1:
                pageLen = (_a.sent())[0];
                len = pageLen[0].cnt;
                maxLen = len - Math.floor(20 * (page - 1));
                minLen = maxLen - 20 > 0 ? maxLen - 20 : 0;
                return [4 /*yield*/, connection_1.default.query("SELECT * FROM contents LIMIT ".concat(minLen, ", ").concat(maxLen))];
            case 2:
                rows = (_a.sent())[0];
                array_1 = [];
